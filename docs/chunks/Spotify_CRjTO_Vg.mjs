const id = "Spotify.md";
						...
						const data = {title:"Equitable Recommendations",authors:["Beleicia Bullock","Amar Assad","Henriette Cramer"],conference:"Internship @ Spotify's Trust and Safety",year:2022,type:"project",paper:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/beleiciabullock/dev/phd-portfolio/src/content/work/Spotify.md",
							rawData: undefined,
						};
