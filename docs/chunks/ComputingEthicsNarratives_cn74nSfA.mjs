const id = "ComputingEthicsNarratives.md";
						const collection = "work";
						const slug = "computingethicsnarratives";
						...
						const data = {title:"Computing ethics narratives: Teaching computing ethics and the impact of predictive algorithms",authors:["Beleicia Bullock","Fernando L. Nascimento","Stacy A. Doore"],conference:"SIGCSE 2021",year:2021,type:"paper",paper:true,link:"../public/pdfs/Bullock2021-ComputingEthicsNarratives.pdf",doi:"https://dl.acm.org/doi/abs/10.1145/3408877.3432468"};
						const _internal = {
							type: 'content',
							filePath: "/Users/beleiciabullock/dev/phd-portfolio/src/content/work/ComputingEthicsNarratives.md",
							rawData: undefined,
						};
